...
for year in range(2017, 2018):
    for month in range(9, 10):
        ...
        for day in range(1, month_range + 1):
            ...
            try:
                io.to_sql("fund_weekly_risk2", conn=engine_wt, dataframe=df_risk2, chunksize=500)
                io.to_sql("fund_weekly_subsidiary2", conn=engine_wt, dataframe=df_sub2, chunksize=500)
                io.to_sql("fund_weekly_subsidiary3", conn=engine_wt, dataframe=df_sub3, chunksize=500)
