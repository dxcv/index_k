...
tasks = [
    (splitter.MysqlReader("org_scale_type", ENGINE_RD), splitter.MysqlReader("org_scale_type", ENGINE_4119PRODUCT)),
    ...
    (splitter.MysqlReader("org_timeseries", ENGINE_RD), splitter.MysqlReader("org_timeseries", ENGINE_4119PRODUCT)),
...
def main():
    ...
    if start is None or end is None:
        ...
        start = end - relativedelta(hours=6, minutes=5)
    if not timechunk:
        timechunk = (0, 1, 0, 0)
