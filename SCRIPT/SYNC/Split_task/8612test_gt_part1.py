...
tasks = [
    ...
    (splitter.MysqlReader("person_info", ENGINE_RD), splitter.MysqlReader("person_info", ENGINE_8612GT)),
    (splitter.MysqlReader("person_description", ENGINE_RD), splitter.MysqlReader("person_description", ENGINE_8612GT)),
