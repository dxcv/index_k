...
from utils.database.config import db_base, db_product
...
tasks = [
    ...
    # (splitter.MysqlReader("fund_subsidiary_weekly_index2", ENGINE_RD), splitter.MysqlReader("fund_weekly_subindex_monthly_returnsidiary", ENGINE_4119PRODUCT)),
...
def main():
    ...
    if start is None or end is None:
        ...
        start = end - relativedelta(days=5, minutes=5)
    if not timechunk:
        timechunk = (1, 0, 0, 0)
