...
tasks = [
    # ["fund_weekly_subsidiary2", ENGINE_GM, "fund_weekly_subsidiary2", ENGINE_8612_gm],
    # ["fund_weekly_subsidiary3", ENGINE_GM, "fund_weekly_subsidiary3", ENGINE_8612_gm],
    ...
    ["fund_income", ENGINE_GM, "fund_income", ENGINE_4119PRODUCT_MUTUAL],
    ["fund_rank", ENGINE_GM, "fund_rank", ENGINE_8612_gm],
...
class sync_same_table:
    ...
    def _get_id(self):
        col = pd.read_sql("SELECT column_name FROM INFORMATION_SCHEMA.`KEY_COLUMN_USAGE`"
                          "WHERE table_name='{}' "
                          "AND CONSTRAINT_SCHEMA='base_public' "
