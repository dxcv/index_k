...
tasks = [
    ...
    (splitter.MysqlReader("org_description", ENGINE_RD), splitter.MysqlReader("org_description", ENGINE_8612GT)),
    ...
    (splitter.MysqlReader("org_monthly_research", ENGINE_RD), splitter.MysqlReader("org_monthly_research", ENGINE_8612GT)),
    (splitter.MysqlReader("org_monthly_return", ENGINE_RD), splitter.MysqlReader("org_monthly_return", ENGINE_8612GT)),
    (splitter.MysqlReader("org_monthly_risk", ENGINE_RD), splitter.MysqlReader("org_monthly_risk", ENGINE_8612GT)),
    (splitter.MysqlReader("org_month_routine", ENGINE_RD), splitter.MysqlReader("org_month_routine", ENGINE_8612GT)),
    (splitter.MysqlReader("org_monthly_index_static", ENGINE_RD), splitter.MysqlReader("org_monthly_index_static", ENGINE_8612GT)),
    (splitter.MysqlReader("org_monthly_index", ENGINE_RD), splitter.MysqlReader("org_monthly_index", ENGINE_8612GT)),
    (splitter.MysqlReader("org_weekly_index_static", ENGINE_RD), splitter.MysqlReader("org_weekly_index_static", ENGINE_8612GT)),
    (splitter.MysqlReader("org_weekly_index", ENGINE_RD), splitter.MysqlReader("org_weekly_index", ENGINE_8612GT)),
]
