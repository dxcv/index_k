...
/usr/local/python3/bin/python3.5 '/home/yusy/IndexCalculation/SCRIPT/PRIVATE/etl/org_info/managers.py';
...
/usr/local/python3/bin/python3.5 '/home/yusy/IndexCalculation/SCRIPT/PRIVATE/etl/org_info/org_region.py';
